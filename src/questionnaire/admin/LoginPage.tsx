...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F3EF] font-sans flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center">
            <div className="w-14 h-14 rounded-2xl bg-[#0B5E47] flex items-center justify-center mx-auto mb-5 shadow-md">
              <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </div>
            <h1 className="text-2xl font-bold text-[#1A2623] mb-1">Clinician sign in</h1>
            <p className="text-[#6B7E7A] text-sm">Access patient submissions and the admin portal.</p>
          </div>

          <form onSubmit={signIn} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-[#6B7E7A] uppercase tracking-widest mb-1.5">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-xs font-bold text-[#6B7E7A] uppercase tracking-widest mb-1.5">Password</label>
              <input
                type="password"
                value={password}
            ...
            <button
              type="submit"
              disabled={busy}
              className="w-full py-4 bg-[#0B5E47] text-white rounded-xl font-bold text-sm hover:bg-[#085041] active:scale-[0.98] transition-all disabled:opacity-60 flex items-center justify-center gap-2 shadow-sm mt-2"
            >
