...
function catColor(color) {
  return C[color] || C.sub;
}
...
function PatientPdfDocument({ record, generatedAt }) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerRow}>
          <View>
            ...
            <Text style={styles.subtitle}>
              Pain Doc Rotorua · Oswestry Disability Index · Hospital Anxiety &
              Depression Scale
            </Text>
          </View>
        ...
        <View style={styles.scoreRow}>
          ...
          <View style={styles.scoreCard}>
            ...
            <Text
              style={[styles.scoreCat, { color: catColor(odiCat.color) }]}
            >
              {odiCat.label}
            </Text>
          </View>
          ...
          <View style={styles.scoreCard}>
            ...
            <Text style={styles.scoreValue}>
              {record.hads.a}
              <Text style={{ fontSize: 10, color: C.faint }}> /21</Text>
            </Text>
            <Text
              style={[styles.scoreCat, { color: catColor(hadsCatA.color) }]}
            >
              {hadsCatA.label}
            </Text>
          </View>
          ...
          <View style={styles.scoreCard}>
            ...
            <Text
              style={[styles.scoreCat, { color: catColor(hadsCatD.color) }]}
            >
              {hadsCatD.label}
            </Text>
          </View>
        ...
        <Text style={styles.sectionTitle}>
          Oswestry Disability Index responses
        </Text>
          ...
          {ODI_QUESTIONS.map((q) => {
            ...
            return (
              <View key={q.id} style={styles.row} wrap={false}>
                ...
                <Text style={styles.aCell}>
                  {val !== undefined ? q.opts[val] : "Not answered"}
                </Text>
        ...
        <Text style={styles.footer} fixed>
          © Dr. Ian Wallbridge. These tools do not substitute for the informed
          opinion of a licensed physician. All scores should be re-checked.
        </Text>
      </Page>
    </Document>
  );
...
export async function downloadPatientPdf(record) {
