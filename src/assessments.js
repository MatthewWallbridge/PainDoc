...
// Single source of truth shared by the app UI and the PDF generator.
...
export function calcODI(answers) {
...
export function odiCategory(pct) {
...
export function calcHADS(answers) {
  let a = 0, d = 0;
...
export function hadsCategory(score) {
